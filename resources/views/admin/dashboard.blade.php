...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">FoodBuddy Dashboard</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
  ...
  <!-- /.content-wrapper -->
   <footer class="main-footer">
    <strong>Copyright &copy; 2021-2050 <a href="http://adminlte.io">FoodBuddy.com</a>.</strong>
    All rights reserved.
    <div class="float-right d-none d-sm-inline-block">
      <b>Created by:-</b>Rohit Parashar
    </div>
  </footer>
