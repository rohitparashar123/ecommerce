        ...
        <table class="email-content" width="100%" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td class="email-masthead">
              <a class="email-masthead_name">FoodBuddy</a>
            </td>
          </tr>
          <!-- Email Body -->
          <tr>
              ...
              <table class="email-body_inner" align="center" width="570" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td class="content-cell">
                    <h1>Hii {{$email_data['name']}} ,</h1>
                    <p>Thanks for signing up for FoodBuddy! We're excited to have you as an early user.<br>
                    ...
                    <p>Thanks,<br>The FoodBuddy Team</p>
                    <!-- Sub copy -->
                    <table class="body-sub">
                      <tr>
                        <td>
                          <p class="sub">Have A Good Day {{$email_data['name']}}!
                          </p>
                         </p>
                        </td>
                      </tr>
              ...
              <table class="email-footer" align="center" width="570" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="content-cell">
                    <p class="sub center">
                      FoodBuddy, Inc.
                      <br>34 C, Shinde Ki Chhawani, Gwalior
                    </p>
                  </td>
                </tr>
              </table>
